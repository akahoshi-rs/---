...
EditText.addEventListener('click', () => {
    ...
    for (let i = 0; i < FlexTextarea.length; i++) {
        document.getElementsByClassName('FlexTextarea__dummy')[i + 1].innerHTML = FlexTextarea[i].innerHTML;
    ...
    for (let i = 0; i < FlexTextarea.length; i++) {
        FlexTextarea[i].addEventListener('input', function () {
            FlexTextarea[i].innerHTML = document.getElementsByClassName('FlexTextarea__dummy')[i + 1].innerHTML;
            let _textValueBefore = FlexTextarea[i].innerHTML;
            let _textValueAfter = _textValueBefore.replace(/\n/g, "");
